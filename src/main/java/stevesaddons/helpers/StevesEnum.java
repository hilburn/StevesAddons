...
public class StevesEnum {
    ...
    private static final Class[][] connectionTypeClasses = new Class[][] {
            { ConnectionBlockType.class, Localization.class, Class.class, boolean.class } };
    private static final Class[][] componentTypeClasses = new Class[][] { { ComponentType.class, int.class,
            Localization.class, Localization.class, ConnectionSet[].class, Class[].class } };
    private static final Class[][] connectionSetClasses = new Class[][] {
            { ConnectionSet.class, Localization.class, ConnectionOption[].class } };
    private static final Class[][] connectionOptionClasses = new Class[][] {
            { ConnectionOption.class, Localization.class, ConnectionOption.ConnectionType.class } };
    ...
    public static final ConnectionBlockType RF_PROVIDER = addConnectionBlockType(
            "RF_PROVIDER",
            TYPE_RF_INPUT,
            IEnergyProvider.class,
            false);
    public static final ConnectionBlockType RF_RECEIVER = addConnectionBlockType(
            "RF_RECEIVER",
            TYPE_RF_OUTPUT,
            IEnergyReceiver.class,
            false);
    public static final ConnectionBlockType RF_CONNECTION = addConnectionBlockType(
            "RF_CONNECTION",
            TYPE_RF,
    ...
    public static final ConnectionOption DELAYED_OUTPUT = addConnectionMethod(
            "DELAYED_OUTPUT",
            DELAY_OUTPUT,
            ConnectionOption.ConnectionType.OUTPUT);
    public static final ConnectionSet DELAYED = addConnectionSet(
            "DELAY_TRIGGER",
            DELAY_TRIGGER,
            new ConnectionOption[] { ConnectionOption.STANDARD_INPUT, DELAYED_OUTPUT });
    ...
    public static ConnectionBlockType addConnectionBlockType(String key, Localization localization, Class theClass,
            boolean group) {
        return EnumHelper.addEnum(connectionTypeClasses, ConnectionBlockType.class, key, localization, theClass, group);
    }

    public static ComponentType addComponentType(String key, int index, Localization shortName, Localization longName,
            ConnectionSet[] connections, Class... classes) {
    ...
    public static ConnectionOption addConnectionMethod(String key, Localization localization,
            ConnectionOption.ConnectionType type) {
    ...
    public static void applyEnumHacks() {
        try {
            ...
            classes.set(
                    ...
                    new Class[] { ComponentMenuReceivers.class, ComponentMenuBUDs.class, ComponentMenuInterval.class,
                            ComponentMenuRedstoneSidesTrigger.class, ComponentMenuRedstoneStrength.class,
                            ComponentMenuUpdateBlock.class, ComponentMenuDelayed.class, ComponentMenuResult.class });
            sets.set(
                    ComponentType.TRIGGER,
