...
public class StevesEnum {
    ...
    private static final Class[][] connectionTypeClasses =
            new Class[][] {{ConnectionBlockType.class, Localization.class, Class.class, boolean.class}};
    private static final Class[][] componentTypeClasses = new Class[][] {
        {ComponentType.class, int.class, Localization.class, Localization.class, ConnectionSet[].class, Class[].class}
    };
    private static final Class[][] connectionSetClasses =
            new Class[][] {{ConnectionSet.class, Localization.class, ConnectionOption[].class}};
    private static final Class[][] connectionOptionClasses =
            new Class[][] {{ConnectionOption.class, Localization.class, ConnectionOption.ConnectionType.class}};
    ...
    public static final ConnectionBlockType RF_PROVIDER =
            addConnectionBlockType("RF_PROVIDER", TYPE_RF_INPUT, IEnergyProvider.class, false);
    public static final ConnectionBlockType RF_RECEIVER =
            addConnectionBlockType("RF_RECEIVER", TYPE_RF_OUTPUT, IEnergyReceiver.class, false);
    public static final ConnectionBlockType RF_CONNECTION =
            addConnectionBlockType("RF_CONNECTION", TYPE_RF, IEnergyConnection.class, true);
    public static final ComponentType RF_INPUT = addComponentType(
            "RF_INPUT",
            17,
            RF_INPUT_SHORT,
            RF_INPUT_LONG,
            new ConnectionSet[] {ConnectionSet.STANDARD},
            ComponentMenuRFInput.class,
            ComponentMenuTargetRF.class,
            ComponentMenuResult.class);
    public static final ComponentType RF_OUTPUT = addComponentType(
            "RF_OUTPUT",
            18,
            RF_OUTPUT_SHORT,
            RF_OUTPUT_LONG,
            new ConnectionSet[] {ConnectionSet.STANDARD},
            ComponentMenuRFOutput.class,
            ComponentMenuTargetRF.class,
            ComponentMenuResult.class);
    public static final ComponentType RF_CONDITION = addComponentType(
            "RF_CONDITION",
            19,
            RF_CONDITION_SHORT,
            RF_CONDITION_LONG,
            new ConnectionSet[] {ConnectionSet.STANDARD_CONDITION},
            ComponentMenuRFStorage.class,
            ComponentMenuTargetRF.class,
            ComponentMenuRFCondition.class,
            ComponentMenuResult.class);
    ...
    public static final ConnectionOption DELAYED_OUTPUT =
            addConnectionMethod("DELAYED_OUTPUT", DELAY_OUTPUT, ConnectionOption.ConnectionType.OUTPUT);
    public static final ConnectionSet DELAYED = addConnectionSet(
            "DELAY_TRIGGER", DELAY_TRIGGER, new ConnectionOption[] {ConnectionOption.STANDARD_INPUT, DELAYED_OUTPUT});
    ...
    public static ConnectionBlockType addConnectionBlockType(
            String key, Localization localization, Class theClass, boolean group) {
        return EnumHelper.addEnum(connectionTypeClasses, ConnectionBlockType.class, key, localization, theClass, group);
    }

    public static ComponentType addComponentType(
            String key,
            int index,
            Localization shortName,
            Localization longName,
            ConnectionSet[] connections,
            Class... classes) {
        return EnumHelper.addEnum(
                componentTypeClasses, ComponentType.class, key, index, shortName, longName, connections, classes);
    }
    ...
    public static ConnectionOption addConnectionMethod(
            String key, Localization localization, ConnectionOption.ConnectionType type) {
    ...
    public static void applyEnumHacks() {
        try {
            ...
            classes.set(ComponentType.TRIGGER, new Class[] {
                ComponentMenuReceivers.class,
                ComponentMenuBUDs.class,
                ComponentMenuInterval.class,
                ComponentMenuRedstoneSidesTrigger.class,
                ComponentMenuRedstoneStrength.class,
                ComponentMenuUpdateBlock.class,
                ComponentMenuDelayed.class,
                ComponentMenuResult.class
            });
            sets.set(ComponentType.TRIGGER, new ConnectionSet[] {
                ConnectionSet.CONTINUOUSLY, ConnectionSet.REDSTONE, ConnectionSet.BUD, DELAYED
            });
        } catch (Exception e) {
            e.printStackTrace();
        }
