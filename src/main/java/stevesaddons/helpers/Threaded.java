...
public class Threaded {
    ...
    public static class Set implements Runnable {
        ...
        public Set(ItemStack duplicator, EntityPlayerMP sender, String[] arguments)
    ...
    public static class Put implements Runnable {
        ...
        public Put(ItemStack duplicator, EntityPlayerMP sender, String[] arguments)
                throws UnsupportedEncodingException {
            this.duplicator = duplicator;
            this.sender = sender;
        ...
        public void run() {
            ...
            if (!sender.mcServer.isDedicatedServer()) {
                ...
                sender.addChatComponentMessage(
                        new ChatComponentText(LocalizationHelper.translate("stevesaddons.command.copiedToClip")));
            }
        }
    }
}
